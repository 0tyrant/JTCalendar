...
@property (nonatomic) UIColor *dayCircleColorTodayBg;

@property (nonatomic) UIColor *dayCircleColorTodayBgOtherMonth;
...
@property (assign, nonatomic) CGFloat todayCircleRatio;
